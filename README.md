...
Gosto de criar ótimos softwares e ajudar as pessoas.
...
```kotlin
object TXRANGEL {
 val name = "João Vitor Rangel Teixeira Domingues"
 val acknowledgements = "Desenvolvimento Web | Full-Stack"
 
 val primarySkillset = listOf("Dedicação", "Clean Code", "Organização")
 val languages = listOf("PHP", "JavaScript", "HTML", "CSS", "ADVPL") 
}
```
